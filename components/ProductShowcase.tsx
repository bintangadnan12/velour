...
// ─── Product Card with 3D tilt on hover ───────────────────────────────────────
function ProductCard({ product, index }: { product: typeof PRODUCTS[0]; index: number }) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        animate={{
          rotateX: hovered ? tilt.x * 0.6 : 0,
          rotateY: hovered ? tilt.y * 0.6 : 0,
      ...
      >
        ...
        <div style={{
          ...
          color: 'rgba(248,246,242,0.55)', letterSpacing: '0.08em',
        }}>
          {product.price}
        </div>
      </motion.div>
      ...
      <div style={{
        ...
        {/* Category */}
        <div style={{ fontSize: 8, letterSpacing: '0.32em', textTransform: 'uppercase', color: 'rgba(248,246,242,0.28)', marginBottom: 10 }}>
          {product.category}
        </div>
        ...
        {/* Tag */}
        <div style={{ fontSize: 8, letterSpacing: '0.24em', textTransform: 'uppercase', color: product.accent, marginBottom: 22, opacity: 0.8 }}>
          {product.tag}
        </div>
        ...
        <motion.div
          ...
          style={{ width: 32, height: 1, background: 'rgba(248,246,242,0.12)', transformOrigin: 'left', marginBottom: 22 }}
        />
        ...
        <motion.p
          ...
          style={{ fontSize: 13, lineHeight: 1.85, color: 'rgba(248,246,242,0.4)', marginBottom: 36, maxWidth: 320 }}
        >
          {product.desc}
        </motion.p>
        ...
        <motion.button
          ...
          onMouseEnter={e => { const t = e.currentTarget; t.style.background = 'rgba(248,246,242,0.08)' }}
          onMouseLeave={e => { const t = e.currentTarget; t.style.background = 'none' }}
        >
          Add to Bag
        </motion.button>
      </div>
...
export function ProductShowcase() {
  return (
    <section id="products" style={{ background: 'var(--black)', padding: 'clamp(80px,12vh,140px) 0' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 'clamp(60px,10vh,120px)', padding: '0 clamp(24px,5vw,80px)' }}>
        <motion.div
          ...
          style={{ fontSize: 9, letterSpacing: '0.34em', textTransform: 'uppercase', color: 'rgba(248,246,242,0.22)', marginBottom: 20 }}
        >
          Best Sellers · AW26
        </motion.div>
        <div style={{ overflow: 'hidden' }}>
          <motion.h2
            ...
            style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(32px,5vw,68px)', fontWeight: 200, color: 'var(--white)', letterSpacing: '-0.01em' }}
          >
